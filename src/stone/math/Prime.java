...
public final class Prime {
    ...
    private static final int sInitPrimeArrayLength = 10000;
    /** [sPrimeArray数组的长度] */
...
//	}
    ...
    //add by huanglm
//	public static boolean isQuickPrime1(int num) {
//		if (num > sMaxCheckedPrime) {
//			boolean flag = true;
//			int i = 0;
//			if((sMaxCheckedPrime+1)*(sMaxCheckedPrime+1) > num){
//			for (; i < sPrimeArrayLength; i++) {
//				if (num % sPrimeArray[i] == 0) {
//					flag = false;
//					break;
//				}
//			}
//			}else {
//				 for (; i < sPrimeArrayLength && (sPrimeArray[i]+1)*(sPrimeArray[i]+1) < num; i++) {
//	                if (num % sPrimeArray[i] == 0) {
//	                    flag = false;
//	                    break;
//	                }
//	            }if (i == sPrimeArrayLength){
//				for (int n = sMaxCheckedPrime; (n+1)*(n+1) < num; n=n+2) {
//					if (num % n == 0) {
//						flag = false;
//						break;
//					}
