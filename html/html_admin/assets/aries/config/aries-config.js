define(function (require, exports, moudles) {
    $.extend($.aries, {
        config: {
            ...
            sec: {
                ...
                //密码不能包含敏感信息
                AUTH_LOGIN_FAILURE_PWD_HAS_SENSITIVE: 'AIAUTH1013',
        ...
        fn: {
            auth: {//安全相关
                ...
                login_timeout: function (code, value) {
                	window.location.href  = '/veris/login.html';
                },
                ...
                login_overload: function (code, value) {
                	$.message.alert("","Account is locked the account login failed three times in a row for 30 minutes.");
                },
	...
	$.extend($.veriscrm, {
		config : {
			common : {
				//请求wechat的url前缀
				WECHAT_REQUEST_URL_PREFIX : 'http://60.194.3.169',
				IS_WECHAT_STATUS_REFRESH_OPEN : true,
				TANENT_DEFALT_VALUE : '10',
				CURRENCY_VALUE : '$' // '€'
			}
		}
	});
